# =================================================================
# SUTTAPLAYER ONNX EXPORT & QUANTIZATION PIPELINE (v1.0.0)
# =================================================================
...
def main():
    ...
    parser.add_argument(
        "--phoneme-map",
        type=str,
        default="/content/drive/MyDrive/sutta-tts-model-training/config/en[gb]_pi[si]-suttaplayer-phoneme-map.json",

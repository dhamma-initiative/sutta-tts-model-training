# =================================================================
# SUTTAPLAYER ONNX EXPORT & QUANTIZATION PIPELINE (v1.0.2)
# =================================================================
...
def generate_piper_json_sidecar(config_path, output_json_path, phoneme_map_path=None):
    ...
    piper_config = {
        ...
        "speaker_id_map": vits_config.get("speaker_id_map", {}),
    }
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to your custom phoneme_map.json (optional, falls back to config)"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
    ...
    # 🚨 CRITICAL FIX: Run explicitly using the Colab-managed python executable
    # resolved at /usr/local/bin/python to inherit all package paths!
    export_cmd = [
        "/usr/local/bin/python", "-m", "piper.train.export_onnx",
